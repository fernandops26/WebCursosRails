class CoordinatorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @coordinator.save
        format.html { redirect_to @coordinator, notice: 'Coordinador correctamente creado.' }
  ...
  def update
    respond_to do |format|
      if @coordinator.update(coordinator_params)
        format.html { redirect_to @coordinator, notice: 'Coordinador correctamente actualizado' }
  ...
  def destroy
    @coordinator.destroy
    respond_to do |format|
      format.html { redirect_to coordinators_url, notice: 'Coordinador correctamente eliminado' }
